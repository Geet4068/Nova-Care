import { useSpecialityById } from '@/CustomHooks/specialization.query';
...
export default function DepartmentSingle() {
    ...
    const { data: specialityData, isPending, isError } = useSpecialityById(department as string);
    ...
    const departmentData = specialityData?.data;
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="block text-center">
                                ...
                                <h1 className="text-capitalize mb-5 text-lg">{departmentData?.department}</h1>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="col-lg-12">
                            <div className="department-img">
                                <Image 
                                    ...
                                    alt={departmentData?.department || 'department'} 
                                    className="img-fluid"
                                    width={1200}
                                    height={600}
                                />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="department-content mt-5">
                                <h3 className="text-md">{departmentData?.department}</h3>
