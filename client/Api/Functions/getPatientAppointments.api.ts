...
export const GetPatientAppointments = async (): Promise<AppointmentResponse> => {
    try {
        ...
        const response = await axiosInstance.get<AppointmentResponse>(endpoints.appointment.getPatientAppointments);

        // console.log("Personal Appointment List Response:", response.data);
